...
function decodeMessageNode(stanza, meId, meLid) {
    ...
    const key = {
        ...
        ...(stanza.attrs.participant_pn ?? participant) !== undefined && { 
            participant: stanza.attrs.participant_pn ?? participant 
        },
        ...(stanza.attrs.participant_pn ?? participant) !== undefined && { 
            participant_pn: stanza.attrs.participant_pn ?? participant 
        },
        ...(stanza.attrs.participant_lid ?? participant) !== undefined && { 
            participant_lid: stanza.attrs.participant_lid ?? participant 
        }
    };
    const fullMessage = {
        key,
